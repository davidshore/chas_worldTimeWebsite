...
export default function Clock( { cityKey } ) {
  ...
  const { city, timeZone } = timeZones[cityKey]; //destructuring
  ...
  return (
    ...
    >
      <div className="text-lg text-gray-700">{city}</div>
      <div className="text-3xl text-slate-900 font-semibold font-mono">
        {time}
      </div>
